...
--
-- Erstellungszeit: 05. Oktober 2011 um 17:30
-- Datenbank: `contentomat14`
--
...
CREATE TABLE `cmt_content_de` (
  ...
  `cmt_pageid` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_objecttemplate` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_objectgroup` int(11) DEFAULT NULL,
  `cmt_position` int(11) DEFAULT NULL,
  `cmt_visible` tinyint(4) DEFAULT NULL,
  `head1` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `head2` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `head3` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `head4` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `head5` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `text1` text CHARACTER SET utf8,
  `text2` text CHARACTER SET utf8,
  `text3` text CHARACTER SET utf8,
  `text4` text CHARACTER SET utf8,
  `text5` text CHARACTER SET utf8,
  `cmt_created` datetime DEFAULT NULL,
  `cmt_createdby` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_lastmodified` datetime DEFAULT NULL,
  `cmt_lastmodifiedby` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `image5` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `html1` text CHARACTER SET utf8,
...
INSERT INTO `cmt_content_de` (`id`, `cmt_pageid`, `cmt_objecttemplate`, `cmt_objectgroup`, `cmt_position`, `cmt_visible`, `head1`, `head2`, `head3`, `head4`, `head5`, `text1`, `text2`, `text3`, `text4`, `text5`, `cmt_created`, `cmt_createdby`, `cmt_lastmodified`, `cmt_lastmodifiedby`, `image1`, `image2`, `image3`, `image4`, `image5`, `html1`, `file1`) VALUES
(1, '3', '2', 1, 1, 1, 'Es sollte eigentlich was angezeigt werden!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-02-17 11:19:59', '1', '2011-02-21 16:11:36', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '3', '8', 1, 2, 1, NULL, NULL, NULL, NULL, NULL, '&nbsp;Sehe was!!!', NULL, NULL, NULL, NULL, '2011-02-17 11:20:02', '1', '2011-02-21 16:11:36', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '7', '2', 1, 1, 1, 'Logg dich ein!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-02-21 16:36:46', '1', '2011-02-21 16:37:03', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '8', '2', 1, 1, 1, 'Gesperrt', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-02-21 18:22:23', '1', '2011-07-21 09:31:07', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, '6', '5', 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-02 17:54:18', '1', '2011-03-02 18:33:48', '1', NULL, NULL, NULL, NULL, NULL, 'Das ist das zweite Feld!', NULL),
(6, '6', '5', 1, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-02 16:00:37', '1', '2011-03-02 18:33:48', '1', NULL, NULL, NULL, NULL, NULL, '<h1>Das ist die &#220;berschrift2</h1> <p>Ein Alter und ein Neuer m&#252;ssen <a href="index.html">Karl-Theodor </a>zu Guttenberg ersetzen.  Innenminister Thomas de Maizi&#232;re wechselt ins Verteidigungsministerium,  die CSU schickt Landesgruppenchef Friedrich als neuen Law-and-Order-Mann  ins Kabinett. Auf den glamour&#246;sen Freiherrn folgen zwei Polit-K&#228;rrne</p>', NULL),
(8, '8', '5', 1, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-07-21 09:30:57', '1', '2011-07-21 09:31:07', '1', NULL, NULL, NULL, NULL, NULL, '', NULL);
...
INSERT INTO `cmt_content_languages` (`id`, `cmt_languagename`, `cmt_language`, `cmt_charset`, `cmt_addquery`, `cmt_position`, `cmt_domain_id`) VALUES
(1, 'deutsch', 'de', 'utf8', '', 1, NULL);
...
(6, '24', 'upload_onupload', '{INCLUDE:PATHTOADMIN.''codemanager/app_gallery/gallery_thumbnailer.inc''}', 'Erstellt beim Laden oder Speichern ein Thumbnail eines Galeriebildes.', 0);
...
CREATE TABLE `cmt_export_saved` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cmt_exportname` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_settings` text CHARACTER SET utf8,
  `cmt_savedby` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_savedat` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_type` varchar(64) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_description` text CHARACTER SET utf8,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
(16, 'cmt_tables', 'cmt_addvars', 'text', 0, '', '', '', 'Interne und eigene Variablen, um die Tabellendarstellung zu steuern.', 'ZusÃ¤tzliche Variablen'),
(17, 'cmt_tables', 'cmt_showfields', 'text', 0, '', '', '', 'Felder, die in dieser Reihenfolge in der Tabellenï¿½bersicht angezeigt werden sollen.', 'ï¿½bersichtsstruktur'),
...
(23, 'cmt_tables', 'cmt_queryvars', 'text', 0, NULL, '', '', 'Optionale Variablen fÃ¼r den Querystring im Navigationslink.<br>Die Variablen mÃ¼ssen durch eine Zeilenschaltung voneinander getrennt werden.', 'Querystring-Variablen'),
...
(27, 'cmt_tables', 'cmt_tablesettings', 'text', 0, NULL, NULL, '', 'Einstellungen fÃ¼r die Tabelle/Applikation (werden serialisiert gespeichert)', 'Tabelleneinstellungen'),
...
(38, 'cmt_tables_groups', 'cmt_isimportgroup', 'flag', 0, NULL, NULL, '0', 'Markiert den Ordner, der fÃ¼r Tabellen-Importe genutzt werden soll.', 'Import-Ordner'),
(39, 'cmt_tables_groups', 'cmt_groupsettings', 'text', 0, NULL, NULL, '', 'Einstellungen fÃ¼r die Gruppe (werden serialisiert gespeichert)', 'Gruppeneinstellungen'),
(50, 'cmt_users_groups', 'cmt_restrictions', 'text', 0, NULL, '', '', 'Definiert EinschrÃ¤nkungen bei der Anzeige der Tabellendaten f&uuml;r diese Benutzergruppe.', 'EinschrÃ¤nkungen'),
(51, 'cmt_users_groups', 'cmt_addvars', 'text', 0, NULL, '', '', 'Einstellungen f&uuml;r die Anwendung / Tabelle', 'Einstellungen'),
(52, 'cmt_users_groups', 'cmt_showfields', 'text', 0, NULL, '', '', 'Angezeigte Felder in der TabellenÃ¼bersicht.', 'Ãœbersicht: angezeigte Felder'),
...
(54, 'cmt_users_groups', 'cmt_grouptype', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:11:"user\r\nadmin";s:7:"aliases";s:23:"Benutzer\r\nAdministrator";s:10:"from_table";s:0:"";s:22:"from_table_value_field";s:0:"";s:22:"from_table_alias_field";s:0:"";s:18:"from_table_add_sql";s:0:"";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', 'user', 'Definiert die grundlegende Art des Benutzers: Nur Benutzer, die die auch am Kern des Systems arbeiten mï¿½ssen, sollten hier als Administratoren definiert werden.', 'Gruppenart'),
...
(71, 'cmt_users', 'cmt_usergroup', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:0:"";s:7:"aliases";s:0:"";s:10:"from_table";s:16:"cmt_users_groups";s:22:"from_table_value_field";s:2:"id";s:22:"from_table_alias_field";s:19:"{VAR:cmt_groupname}";s:18:"from_table_add_sql";s:22:"ORDER BY cmt_groupname";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Gruppe, zu der dieser Benutzer gehï¿½rt.', 'Benutzergruppe'),
(72, 'cmt_users', 'cmt_restrictions', 'text', 0, NULL, '', '', 'Weitere EinschrÃ¤nkungen f&uuml;r den Benutzer in der Tabellenansicht.', 'EinschrÃ¤nkungen'),
(73, 'cmt_users', 'cmt_addvars', 'text', 0, NULL, '', '', 'Tabelleneinstellungen.', 'Einstellungen'),
(74, 'cmt_users', 'cmt_showfields', 'text', 0, NULL, '', '', 'Angezeigte Felder in der TabellenÃ¼bersicht.', 'Ãœbersicht: angezeigte Felder'),
...
(80, 'cmt_users', 'cmt_passchanged', 'datetime', 0, '', 'a:1:{s:7:"current";s:1:"1";}', '0000-00-00 00:00:00', 'Letzte Ã„nderung des Benutzerpasswortes.', 'Passwort zuletzt geÃ¤ndert'),
...
(83, 'cmt_users', 'cmt_showitems', 'text', 0, NULL, '', '', 'Tabellen / Applikationen, die fÃ¼r den User angezeigt werden.', 'Angezeigte Tabellen'),
(84, 'cmt_users', 'cmt_usertype', 'string', 0, NULL, '', '', 'Art des Benutzers (wird automatisch beim Speichern aus der zugehÃ¶rigen Gruppe erzeugt).', 'Benutzerart'),
(85, 'cmt_users', 'cmt_userdirectory', 'string', 0, NULL, '', '', 'PersÃ¶nliches Verzeichnis des Benutzers', 'persÃ¶nliches Verzeichnis'),
...
(97, 'cmt_sessions', 'cmt_vars', 'text', 0, '', '', '', 'Container fÃ¼r serialisierte Session Variablen', 'Session-Vars'),
...
(111, 'cmt_content_de', 'cmt_objecttemplate', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:0:"";s:7:"aliases";s:0:"";s:10:"from_table";s:21:"cmt_templates_objects";s:22:"from_table_value_field";s:2:"id";s:22:"from_table_alias_field";s:14:"{VAR:cmt_name}";s:18:"from_table_add_sql";s:21:"ORDER BY cmt_position";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Verwendete Layoutvorlage fï¿½r dieses Objekt.', 'Layoutvorlage'),
...
(155, 'cmt_links_de', 'cmt_lang', 'string', 0, '', '', '', 'Sprache der Seite zu welcher der Link gehÃ¶rt', 'Sprache'),
...
(170, 'cmt_pages_de', 'cmt_type', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:18:"page\r\nfolder\r\nlink";s:7:"aliases";s:19:"Seite\r\nOrdner\r\nLink";s:10:"from_table";s:0:"";s:22:"from_table_value_field";s:0:"";s:22:"from_table_alias_field";s:0:"";s:18:"from_table_add_sql";s:0:"";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Art des Eintrags: Seite, Ordner oder Link (wird nur in der Ãœbersicht angezeigt, nicht in der Navigation)', 'Typ'),
(257, 'cmt_pages_de', 'cmt_relations', 'relation', NULL, NULL, 'a:2:{s:10:"from_table";s:141:"a:1:{i:1;s:122:"a:4:{s:4:"name";s:14:"cmt_content_de";s:11:"value_field";s:2:"id";s:11:"alias_field";s:8:"{VAR:id}";s:7:"add_sql";s:0:"";}";}";s:18:"multiple_separator";s:1:",";}', '', 'Sofern eingerichtet, ist hier die Auswahl von Verknüpfungen (Relationen) zu anderen Datenbanktabelleneinträgen für diese Seite möglich.', 'Verknüpfungen'),
...
(177, 'cmt_pages_de', 'cmt_protected', 'flag', NULL, NULL, 'a:1:{s:5:"value";s:0:"";}', '', 'Zeigt an, ob die Seite / der Ordner passwortgeschÃ¼tzt sein soll. Ist dieses Feld angekreuzt, mÃ¼ssen auch die nachfolgenden EintrÃ¤ge ausgefÃ¼llt werden!', 'Seite geschützt'),
...
(179, 'cmt_pages_de', 'cmt_protected_loginpage', 'select_recursive', NULL, NULL, 'a:6:{s:11:"noselection";s:0:"";s:10:"from_table";s:12:"cmt_pages_de";s:6:"parent";s:2:"id";s:18:"parent_value_field";s:12:"cmt_parentid";s:18:"parent_alias_field";s:9:"cmt_title";s:7:"add_sql";s:20:"ORDER BY cmt_pagepos";}', '', 'Seite zu der umgeleitet wird, wenn der Besucher (noch) nicht eingeloggt ist. Hier sollte eine Seite ausgewÃ¤hlt werden, auf welcher sich ein Login-Formular befindet.', 'Login-Seite'),
(180, 'cmt_pages_de', 'cmt_link', 'string', NULL, NULL, '', '', 'URL des manuell eingefÃ¼gten Links', 'Link-URL'),
(181, 'cmt_pages_de', 'cmt_link_target', 'string', NULL, NULL, '', '', 'Zielfenster des manuell eingefÃ¼gten Links, z.B. _blank', 'Zielfenster'),
...
(256, 'dev_testtable', 'field_html', 'html', NULL, NULL, 'a:7:{s:6:"editor";s:2:"on";s:13:"tinymce_theme";s:6:"simple";s:17:"tinymce_image_dir";s:4:"img/";s:19:"tinymce_content_css";s:13:"css/style.css";s:14:"tinymce_height";s:0:"";s:13:"tinymce_width";s:0:"";s:12:"tinymce_vars";s:0:"";}', '', '', 'HTML-Feld'),
(258, 'dev_testtable', 'test_select', 'select', NULL, NULL, 'a:11:{s:11:"noselection";s:0:"";s:18:"multiple_separator";s:8:"__scol__";s:6:"values";s:7:"1\r\n2\r\n3";s:7:"aliases";s:16:"eins\r\nzwei\r\ndrei";s:10:"from_table";s:0:"";s:22:"from_table_alias_field";s:0:"";s:18:"from_table_add_sql";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', '', 'Auswahllistentest'),
(267, 'gallery_images', 'gallery_image_description', 'text', NULL, NULL, '', '', '', 'Bildbeschreibung'),
(268, 'gallery_images', 'gallery_image_file', 'upload', NULL, NULL, 'a:3:{s:3:"dir";s:0:"";s:11:"other_table";s:0:"";s:22:"this_table_field_value";s:0:"";}', '', '', 'Bilddatei'),
(270, 'gallery_images', 'gallery_image_internal_filename', 'string', NULL, NULL, '', '', 'Interner Name der Datei. Wird beim Hochladen automatisch erzeugt.', 'Interner Dateiname'),
(263, 'dev_testtable', 'test_relation', 'relation', NULL, NULL, 'a:2:{s:10:"from_table";s:137:"a:1:{i:0;s:118:"a:4:{s:4:"name";s:13:"dev_testtable";s:11:"value_field";s:2:"id";s:11:"alias_field";s:5:"title";s:7:"add_sql";s:0:"";}";}";s:18:"multiple_separator";s:1:",";}', '', '', 'Relations'),
(264, 'gallery_categories', 'gallery_category_title', 'string', NULL, NULL, '', '', '', 'Kategorietitel'),
(265, 'gallery_categories', 'gallery_category_description', 'text', NULL, NULL, '', '', '', 'Kategoriebeschreibung'),
(266, 'gallery_images', 'gallery_image_title', 'string', NULL, NULL, '', '', '', 'Bildtitel'),
(269, 'gallery_images', 'gallery_image_category_id', 'select', NULL, NULL, 'a:12:{s:11:"noselection";s:0:"";s:18:"multiple_separator";s:8:"__scol__";s:6:"values";s:0:"";s:7:"aliases";s:0:"";s:10:"from_table";s:18:"gallery_categories";s:22:"from_table_value_field";s:2:"id";s:22:"from_table_alias_field";s:28:"{VAR:gallery_category_title}";s:18:"from_table_add_sql";s:35:"ORDER BY gallery_category_title ASC";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', '', 'Kategorie'),
(262, 'dev_testtable', 'title', 'string', NULL, NULL, '', '', '', 'Titel'),
(271, 'gallery_images', 'gallery_image_position', 'position', NULL, NULL, 'a:1:{s:6:"parent";s:25:"gallery_image_category_id";}', '', 'Reihenfolge des Bildes innerhalb einer Kategorie', 'Reihenfolge'),
(272, 'dev_testtable', 'path', 'upload', NULL, NULL, 'a:3:{s:3:"dir";s:7:"config/";s:11:"other_table";s:0:"";s:22:"this_table_field_value";s:0:"";}', '', '', 'Pfad');
...
CREATE TABLE `cmt_links_de` (
  ...
  `cmt_page` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_url` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_target` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_addhtml` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_linkonpage` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_created` datetime DEFAULT NULL,
  `cmt_createdby` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_lastmodified` datetime DEFAULT NULL,
  `cmt_lastmodifiedby` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_lang` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `cmt_pages_de` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cmt_title` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_parentid` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_pagepos` int(11) NOT NULL DEFAULT '0',
  `cmt_template` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_urlalias` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_type` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_isroot` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_creationdate` datetime DEFAULT NULL,
  `cmt_createdby` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_showinnav` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_pageid` int(11) DEFAULT NULL,
  `cmt_protected` tinyint(4) DEFAULT NULL,
  `cmt_protected_var` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_protected_loginpage` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_link` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_link_target` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_domain_id` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_relations` text CHARACTER SET utf8,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=9 ;
...
INSERT INTO `cmt_pages_de` (`id`, `cmt_title`, `cmt_parentid`, `cmt_pagepos`, `cmt_template`, `cmt_urlalias`, `cmt_type`, `cmt_isroot`, `cmt_creationdate`, `cmt_createdby`, `cmt_showinnav`, `cmt_pageid`, `cmt_protected`, `cmt_protected_var`, `cmt_protected_loginpage`, `cmt_link`, `cmt_link_target`, `cmt_domain_id`, `cmt_relations`) VALUES
(1, 'WEBSITE', 'root', 1, '1', '', 'folder', '1', '2009-04-06 12:00:00', '1', '1', 1, 0, '', 'root', '', '', NULL, NULL),
(2, 'TESTAREA', 'root', 2, '1', '', 'folder', '0', '2009-04-06 12:00:00', '1', '1', 0, 0, '', 'root', '', '', '', NULL),
(3, 'Testseite', '1', 1, '1', '', 'page', '0', '2009-04-06 20:08:38', '1', '1', 0, 1, 'cmt_visitorloggedin', '7', '', '', '', NULL),
(4, 'Zweite Testseite', '2', 1, '1', '', 'page', '0', '2011-02-17 17:55:35', '1', '99', 0, 1, 'cmt_visitorloggedin', 'root', '', '', '', NULL),
(5, 'Testordner', '2', 2, '1', '', 'folder', '0', '2011-02-17 17:56:02', '1', '1', 0, 0, 'cmt_visitorloggedin', 'root', '', '', '', NULL),
(6, 'Unterseite von Testordner', '5', 1, '1', '', 'page', '0', '2011-02-17 18:02:13', '1', '1', 0, 0, 'cmt_visitorloggedin', 'root', '', '', '', NULL),
(7, 'Loginseite', '1', 2, '1', '', 'page', '0', '2011-02-21 16:35:51', '1', '1', 0, 0, 'cmt_visitorloggedin', 'root', '', '', '', NULL),
(8, 'sdfsdffsd', '2', 3, '1', '', 'page', '0', '2011-02-21 17:42:18', '1', '1', 0, 0, 'cmt_visitorloggedin', 'root', '', '', '', '');
...
CREATE TABLE `cmt_sessions_raw` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cmt_sessionid` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `cmt_time` int(11) DEFAULT NULL,
  `cmt_page` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `cmt_session_details` (
  ...
  `cmt_loggedin` tinyint(1) DEFAULT '0',
  `cmt_userid` int(11) DEFAULT NULL,
  `cmt_useragent` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `cmt_referer` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `cmt_tables` (
  ...
  `cmt_include` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `cmt_tables` (`id`, `cmt_tablename`, `cmt_showname`, `cmt_charset`, `cmt_collation`, `cmt_include`, `cmt_itempos`, `cmt_addvars`, `cmt_showfields`, `cmt_editstruct`, `cmt_group`, `cmt_ownservice`, `cmt_type`, `cmt_templates`, `cmt_itemvisible`, `cmt_target`, `cmt_queryvars`, `cmt_systemtable`, `cmt_tablesettings`) VALUES
(1, '', 'Datei-Manager', '', NULL, 'app_filebrowser.php', 1, 'uploads = 6\r\nroot = \r\nshow_all_subfolders =', '', '', '1', '', 'application', '', 1, NULL, NULL, NULL, 'a:3:{s:4:"icon";s:7:"default";s:4:"root";s:4:"img/";s:7:"uploads";s:1:"4";}'),
...
(11, 'cmt_content_de', 'Content', 'utf8', 'utf8_unicode_ci', '', 5, 'sort_fields = 2\nsort_directions = 2\nsearch_fields = 2\nshow_ipp = 1\nshow_iteminfos = 1\nadd_item = 1\nsort_aliases = 1\nshow_pageselect = 1\nsearch_aliases = 1\ntable_alias = \nshow_ippnumber = 10\nshow_query = \ncmt_ownservice = \ntable_icon = ', '', '', '16', '', 'table', '', 0, '', '', 0, 'a:12:{s:10:"table_icon";s:7:"default";s:11:"sort_fields";s:1:"2";s:12:"sort_aliases";s:1:"1";s:15:"sort_directions";s:1:"2";s:13:"search_fields";s:1:"2";s:14:"search_aliases";s:1:"1";s:8:"show_ipp";s:1:"1";s:14:"show_ippnumber";s:2:"10";s:15:"show_pageselect";s:1:"1";s:14:"show_iteminfos";s:1:"1";s:14:"cmt_ownservice";s:0:"";s:10:"show_query";s:1:"1";}'),
...
(20, 'dev_testtable', 'Testtabelle', 'utf8', 'utf8_unicode_ci', NULL, 1, NULL, NULL, NULL, '20', NULL, 'table', NULL, 1, '', '', 0, 'a:19:{s:11:"sort_fields";s:1:"2";s:15:"sort_directions";s:1:"2";s:12:"sort_aliases";s:1:"1";s:13:"search_fields";s:1:"2";s:14:"search_aliases";s:1:"1";s:8:"show_ipp";s:1:"1";s:14:"show_ippnumber";s:2:"10";s:15:"show_pageselect";s:1:"1";s:14:"show_iteminfos";s:1:"1";s:8:"add_item";s:1:"1";s:11:"enter_query";s:1:"0";s:10:"show_query";s:1:"0";s:14:"cmt_ownservice";s:0:"";s:4:"icon";s:24:"cmt_defaulttableicon.png";s:18:"external_templates";s:25:"admin/external_templates/";s:11:"big_buttons";s:0:"";s:9:"hover_row";s:1:"1";s:9:"max_chars";s:3:"200";s:18:"max_chars_appendix";s:3:"...";}'),
(22, NULL, 'Galerie bearbeiten', '', NULL, 'app_gallery.inc', 1, NULL, '', '', '21', NULL, 'application', 'a:4:{s:18:"dont_use_templates";s:1:"1";s:14:"overview_frame";s:0:"";s:12:"overview_row";s:0:"";s:10:"edit_entry";s:0:"";}', 1, '', '', 0, NULL),
(23, 'gallery_categories', 'Galerie-Kategorien', 'utf8', 'utf8_unicode_ci', NULL, 2, NULL, '', '{DONTSHOW}id\r\ngallery_category_title\r\ngallery_category_description', '21', NULL, 'table', NULL, 0, '', '', 0, 'a:19:{s:11:"sort_fields";s:1:"2";s:15:"sort_directions";s:1:"2";s:12:"sort_aliases";s:1:"1";s:13:"search_fields";s:1:"2";s:14:"search_aliases";s:1:"1";s:8:"show_ipp";s:1:"1";s:14:"show_ippnumber";s:2:"10";s:15:"show_pageselect";s:1:"1";s:14:"show_iteminfos";s:1:"1";s:8:"add_item";s:1:"1";s:11:"enter_query";s:1:"0";s:10:"show_query";s:1:"0";s:14:"cmt_ownservice";s:0:"";s:4:"icon";s:24:"cmt_defaulttableicon.png";s:18:"external_templates";s:25:"admin/external_templates/";s:11:"big_buttons";s:0:"";s:9:"hover_row";s:1:"1";s:9:"max_chars";s:3:"200";s:18:"max_chars_appendix";s:3:"...";}'),
(24, 'gallery_images', 'Galerie-Bilder', 'utf8', 'utf8_unicode_ci', NULL, 3, NULL, 'id\r\ngallery_image_title\r\ngallery_image_file\r\ngallery_image_internal_filename\r\ngallery_image_category_id\r\ngallery_image_position', '{DONTSHOW}id\r\ngallery_image_file\r\ngallery_image_title\r\n{HEAD}optionale Angaben\r\ngallery_image_description\r\n{HIDDEN}gallery_image_category_id\r\n{DONTSHOW}gallery_image_internal_filename\r\n{DONTSHOW}gallery_image_position', '21', NULL, 'table', NULL, 0, '', '', 0, 'a:19:{s:11:"sort_fields";s:1:"2";s:15:"sort_directions";s:1:"2";s:12:"sort_aliases";s:1:"1";s:13:"search_fields";s:1:"2";s:14:"search_aliases";s:1:"1";s:8:"show_ipp";s:1:"1";s:14:"show_ippnumber";s:2:"10";s:15:"show_pageselect";s:1:"1";s:14:"show_iteminfos";s:1:"1";s:8:"add_item";s:1:"1";s:11:"enter_query";s:1:"0";s:10:"show_query";s:1:"0";s:14:"cmt_ownservice";s:0:"";s:4:"icon";s:24:"cmt_defaulttableicon.png";s:18:"external_templates";s:25:"admin/external_templates/";s:11:"big_buttons";s:0:"";s:9:"hover_row";s:1:"1";s:9:"max_chars";s:3:"200";s:18:"max_chars_appendix";s:3:"...";}');
...
INSERT INTO `cmt_tables_groups` (`id`, `cmt_groupname`, `cmt_grouppos`, `cmt_visible`, `cmt_isimportgroup`, `cmt_groupsettings`) VALUES
(1, 'Administration', 4, 1, 0, 'a:2:{s:4:"icon";s:9:"otherIcon";s:8:"iconPath";s:24:"altimg/groups/1/icon.png";}'),
(15, 'Benutzer', 5, 1, 0, 'a:2:{s:4:"icon";s:9:"otherIcon";s:8:"iconPath";s:25:"altimg/groups/15/icon.png";}'),
(16, 'Website', 3, 1, 0, 'a:2:{s:4:"icon";s:9:"otherIcon";s:8:"iconPath";s:25:"altimg/groups/16/icon.png";}'),
(17, 'Templates', 7, 1, 0, 'a:2:{s:4:"icon";s:9:"otherIcon";s:8:"iconPath";s:25:"altimg/groups/17/icon.png";}'),
(19, 'Import-Ordner', 8, 0, 1, 'a:2:{s:4:"icon";s:9:"otherIcon";s:8:"iconPath";s:37:"../admin/altimages/groups/19/icon.png";}'),
(20, 'Testtabellen', 1, 1, 0, NULL),
(21, 'Galerie', 2, 1, 0, NULL);
...
INSERT INTO `cmt_templates_objects` (`id`, `cmt_name`, `cmt_source`, `cmt_position`) VALUES
(2, 'Überschrift 1. Grades', '<h1>{HEAD:1}</h1>', 1),
...
INSERT INTO `cmt_templates_pages` (`id`, `cmt_name`, `cmt_source`, `cmt_position`) VALUES
(1, 'Standardseite', '{INCLUDE:PATHTOWEBROOT.\\"templates/standard.tpl\\"}', 1);
...
CREATE TABLE `cmt_users` (
  ...
  `cmt_userdirectory` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `cmt_users` (`id`, `cmt_username`, `cmt_pass`, `cmt_exptime`, `cmt_uservars`, `cmt_creationdate`, `cmt_passchanged`, `cmt_lastlogin`, `cmt_usergroup`, `cmt_restrictions`, `cmt_addvars`, `cmt_showfields`, `cmt_editstruct`, `cmt_useralias`, `cmt_showitems`, `cmt_usertype`, `cmt_userdirectory`, `cmt_startpage`, `cmt_startapp`, `cmt_cmtstyle`) VALUES
(1, 'cmt', '2ec987485e4d734faeb439a7427f8633', 0, 'a:1:{s:12:"cmt_uservars";a:14:{i:18;a:3:{s:7:"cmt_ipp";s:2:"20";s:7:"sort_by";a:1:{i:1;s:14:"error_datetime";}s:8:"sort_dir";a:1:{i:1;s:4:"desc";}}i:2;a:1:{s:6:"cmtIpp";s:2:"30";}i:11;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:1;a:2:{s:6:"sortBy";s:0:"";s:7:"sortDir";s:0:"";}i:14;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";a:1:{i:1;s:12:"cmt_position";}s:8:"sort_dir";a:1:{i:1;s:3:"asc";}}i:8;a:3:{s:7:"cmt_ipp";s:0:"";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:13;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:20;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"sort_dir";a:2:{i:1;s:3:"asc";i:2;s:3:"asc";}}i:21;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:4;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:24;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:19;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:22;a:3:{s:7:"cmt_ipp";s:0:"";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}i:23;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}}}', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2011-10-05 17:01:54', '1', '', '', '', '', 'John Doe', '', 'admin', '', '', '17', 'default/');
...
INSERT INTO `cmt_users_groups` (`id`, `cmt_groupname`, `cmt_showitems`, `cmt_restrictions`, `cmt_addvars`, `cmt_showfields`, `cmt_editstruct`, `cmt_grouptype`, `cmt_startpage`, `cmt_startapp`, `cmt_groupdirectory`) VALUES
...
--
-- Tabellenstruktur für Tabelle `dev_testtable`
--

DROP TABLE IF EXISTS `dev_testtable`;
CREATE TABLE `dev_testtable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `field_html` text COLLATE utf8_unicode_ci,
  `test_select` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `test_relation` text COLLATE utf8_unicode_ci,
  `path` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;

--
-- Daten für Tabelle `dev_testtable`
--
...
INSERT INTO `gallery_categories` (`id`, `gallery_category_title`, `gallery_category_description`) VALUES
(1, 'erste Kategorie', '');
