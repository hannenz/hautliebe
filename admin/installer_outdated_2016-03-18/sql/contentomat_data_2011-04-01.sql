...
--
-- Host: localhost
-- Erstellungszeit: 06. April 2009 um 20:41
-- Server Version: 5.0.67
-- PHP-Version: 5.2.6-2ubuntu4.1

--
-- Datenbank: `contentomat`
--
...
CREATE TABLE `cmt_content_languages` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_languagename` varchar(255) default NULL,
  `cmt_language` varchar(255) default NULL,
  `cmt_charset` varchar(255) default NULL,
  `cmt_addquery` varchar(255) default NULL,
...
INSERT INTO `cmt_content_languages` (`id`, `cmt_languagename`, `cmt_language`, `cmt_charset`, `cmt_addquery`, `cmt_position`) VALUES
(1, 'deutsch', 'de', 'utf8', '', 1);
...
CREATE TABLE `cmt_dberrorlog` (
  ...
  `mysql_error_message` text,
  `mysql_query` text,
  `script_name` varchar(255) default NULL,
  `cmt_pageid` int(11) default NULL,
  `cmt_pagelang` varchar(255) default NULL,
  `cmt_applicationid` varchar(255) default NULL,
  `script_querystring` text,
  `cmt_userid` int(11) default NULL,
  `referer_ip` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;
...
CREATE TABLE `cmt_execute_code` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_tablename` varchar(255) default NULL,
  `cmt_executiontime` varchar(255) default NULL,
  `cmt_code` text,
  `cmt_description` text,
...
CREATE TABLE `cmt_export_saved` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_exportname` varchar(255) default NULL,
  `cmt_settings` text,
  `cmt_savedby` varchar(255) default NULL,
  `cmt_savedat` varchar(255) default NULL,
  `cmt_type` varchar(64) default NULL,
  `cmt_description` text,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;
...
CREATE TABLE `cmt_fields` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_tablename` varchar(64) default NULL,
  `cmt_fieldname` varchar(64) default NULL,
  `cmt_fieldtype` varchar(64) default NULL,
  `cmt_index` tinyint(1) default '0',
  `cmt_fieldquery` text,
  `cmt_options` text,
  `cmt_default` text,
  `cmt_fielddesc` text,
  `cmt_fieldalias` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM ;
...
(1, 'cmt_execute_code', 'cmt_tablename', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:0:"";s:7:"aliases";s:0:"";s:10:"from_table";s:10:"cmt_tables";s:22:"from_table_value_field";s:2:"id";s:22:"from_table_alias_field";s:18:"{VAR:cmt_showname}";s:18:"from_table_add_sql";s:60:"WHERE cmt_type=__bksl__''table__bksl__'' ORDER BY cmt_showname";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Name der Tabelle / Application', 'Tabelle'),
(2, 'cmt_execute_code', 'cmt_executiontime', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:243:"overview_onload\r\noverview_onshow_entry\r\noverview_aftershow_entry\r\noverview_oncomplete\r\nentry_onload\r\nentry_onshow_field\r\nentry_aftershow_field\r\nentry_oncomplete\r\nentry_onsave\r\nentry_aftersave\r\nentry_ondelete\r\nentry_afterdelete\r\nupload_onupload";s:7:"aliases";s:415:"Übersicht: beim Laden\r\nÜbersicht: vor dem  Anzeigen einer Zeile\r\nÜbersicht: nach dem  Anzeigen einer Zeile\r\nÜbersicht: am Ende der Seite\r\nEintrag: beim Laden\r\nEintrag: vor dem Anzeigen jedes Feldes\r\nEintrag: nach dem Anzeigen jedes Feldes\r\nEintrag: am Ende der Seite\r\nEintrag: vor dem Speichern\r\nEintrag: nach dem Speichern\r\nEintrag: vor dem Löschen\r\nEintrag: nach dem Löschen\r\nnach dem Upload, vor Dateispeicherung";s:10:"from_table";s:0:"";s:22:"from_table_value_field";s:0:"";s:22:"from_table_alias_field";s:0:"";s:18:"from_table_add_sql";s:0:"";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Zeitpunkt und Ort, zu welchen der PHP-Code ausgeführt werden soll.', 'Ausführungszeitpunkt'),
(3, 'cmt_execute_code', 'cmt_code', 'text', 0, '', '', '{EVAL}\r\n\r\n{ENDEVAL}', 'PHP-Code, der ausgeführt werden soll. Der PHP-Code muss innerhalb eines {EVAL}...{ENDEVAL}-Blockes stehen, da auch alle andere Parser-Makros zur Verfügung stehen.<br> <br>', 'Code-Quelltext'),
...
(5, 'cmt_execute_code', 'cmt_isinternal', 'flag', 0, NULL, '', '0', 'Ist diese Option ausgewählt, wird dieser Quelltext als f&uuml;r das Funktionieren des Systems relevant angesehen und kann nur durch einen Administrator bearbeitet / gelöscht werden.', 'Content-O-Mat Quelltext'),
...
(17, 'cmt_tables', 'cmt_showfields', 'text', 0, '', '', '', 'Felder, die in dieser Reihenfolge in der Tabellen�bersicht angezeigt werden sollen.', '�bersichtsstruktur'),
...
(54, 'cmt_users_groups', 'cmt_grouptype', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:11:"user\r\nadmin";s:7:"aliases";s:23:"Benutzer\r\nAdministrator";s:10:"from_table";s:0:"";s:22:"from_table_value_field";s:0:"";s:22:"from_table_alias_field";s:0:"";s:18:"from_table_add_sql";s:0:"";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', 'user', 'Definiert die grundlegende Art des Benutzers: Nur Benutzer, die die auch am Kern des Systems arbeiten m�ssen, sollten hier als Administratoren definiert werden.', 'Gruppenart'),
...
(71, 'cmt_users', 'cmt_usergroup', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:0:"";s:7:"aliases";s:0:"";s:10:"from_table";s:16:"cmt_users_groups";s:22:"from_table_value_field";s:2:"id";s:22:"from_table_alias_field";s:19:"{VAR:cmt_groupname}";s:18:"from_table_add_sql";s:22:"ORDER BY cmt_groupname";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Gruppe, zu der dieser Benutzer geh�rt.', 'Benutzergruppe'),
...
(111, 'cmt_content_de', 'cmt_objecttemplate', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:0:"";s:7:"aliases";s:0:"";s:10:"from_table";s:21:"cmt_templates_objects";s:22:"from_table_value_field";s:2:"id";s:22:"from_table_alias_field";s:14:"{VAR:cmt_name}";s:18:"from_table_add_sql";s:21:"ORDER BY cmt_position";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '', 'Verwendete Layoutvorlage f�r dieses Objekt.', 'Layoutvorlage'),
...
(115, 'cmt_content_de', 'head1', 'string', 0, '', '', '', '', 'Überschrift 1'),
(116, 'cmt_content_de', 'head2', 'string', 0, '', '', '', '', 'Überschrift 2'),
(117, 'cmt_content_de', 'head3', 'string', 0, '', '', '', '', 'Überschrift 3'),
(118, 'cmt_content_de', 'head4', 'string', 0, '', '', '', '', 'Überschrift 4'),
(119, 'cmt_content_de', 'head5', 'string', 0, '', '', '', '', 'Überschrift 5'),
...
(149, 'cmt_links_de', 'cmt_addhtml', 'string', 0, '', '', '', 'Optional: Zusätzliche HTML-Angaben wie ''style="..."'', ''class="..."'' oder onClick="Javascript".', 'zusätzliches HTML'),
...
(169, 'cmt_pages_de', 'cmt_urlalias', 'string', 0, '', '', '', 'Name der in der Seiten-URL angezeigt wird', 'Aliasname für URL'),
...
(171, 'cmt_pages_de', 'cmt_lang', 'string', 0, '', '', '', 'Sprache der Seite', 'Sprache'),
...
(175, 'cmt_pages_de', 'cmt_showinnav', 'select', NULL, NULL, 'a:14:{s:11:"noselection";s:0:"";s:6:"values";s:8:"1\r\n0\r\n99";s:7:"aliases";s:50:"anzeigen\r\nverbergen (über ID erreichbar)\r\nsperren";s:10:"from_table";s:0:"";s:22:"from_table_value_field";s:0:"";s:22:"from_table_alias_field";s:0:"";s:18:"from_table_add_sql";s:0:"";s:18:"multiple_separator";s:0:"";s:21:"recursive_noselection";s:0:"";s:20:"recursive_from_table";s:0:"";s:16:"recursive_parent";s:0:"";s:28:"recursive_parent_value_field";s:0:"";s:28:"recursive_parent_alias_field";s:0:"";s:17:"recursive_add_sql";s:0:"";}', '1', 'Definiert, ob die Seite in der Navigation angezeigt werden soll. Ggf. (abhängig vom Seitentemplate) muss ein Ordner, in welchem sich eine Seite befindet, die nicht in der Navigation angezeigt werden soll, ebenfalls auf ''verbergen'' gestellt werden.', 'in Navigation anzeigen'),
(176, 'cmt_pages_de', 'cmt_pageid', 'integer', 0, NULL, NULL, '', '', 'Seiten-ID'),
(177, 'cmt_pages_de', 'cmt_protected', 'flag', 0, NULL, NULL, '0', 'Zeigt an, ob die Seite / der Ordner passwortgeschützt sein soll. Ist dieses Feld angekreuzt, müssen auch die nachfolgenden Einträge ausgefüllt werden!', 'Seite geschützt'),
...
(225, 'cmt_content_languages', 'cmt_languagename', 'string', 0, NULL, NULL, '', 'Sprache (Bezeichnung) für welche eine neue Website-Version erzeugt werden soll.', 'Sprache'),
(226, 'cmt_content_languages', 'cmt_language', 'string', 0, NULL, NULL, '', 'Sprachkürzel, welches intern für die Sprachversion verwendet werden soll.\r\nDie Abkürzung sollte so kurz wie möglich gewählt werden, z.B. <i>en</i>, <i>fr</i> oder <i>it</i>. Bitte verwenden Sie keine Sonder- oder Leerzeichen im Kürzel.', 'Sprachkürzel'),
(227, 'cmt_content_languages', 'cmt_charset', 'string', 0, NULL, NULL, '', 'Wählen Sie hier den passenden Zeichensatz für die Website-Inhalte. Bitte beachten Sie, dass eine nachträgliche Änderung des Zeichensatzes zu fehlerhafter Darstellung der Websiteinhalte der gewählten Sprache führen kann.', 'Zeichensatz'),
(228, 'cmt_content_languages', 'cmt_addquery', 'string', 0, NULL, NULL, '', 'Hier können eigene Auswahlkriterien für die MySQL-Query, welche die Seiten aufruft, angegeben werden.\r\n\r\n<i>AND myfield=''1''</i>\r\n\r\nz.B. würde nur die Seiten ausgeben, die die Eigenschaften ''anzeigen'' und ''myfield=1'' erfüllen.', 'zusatzliche MySQL-Kriterien'),
(229, 'cmt_content_languages', 'cmt_position', 'position', 0, NULL, NULL, '', 'Regelt die Position der Sprachversion auf der Übersichtsseite.', 'Position'),
...
INSERT INTO `cmt_pages_de` (`id`, `cmt_title`, `cmt_parentid`, `cmt_pagepos`, `cmt_template`, `cmt_urlalias`, `cmt_type`, `cmt_lang`, `cmt_isroot`, `cmt_creationdate`, `cmt_createdby`, `cmt_showinnav`, `cmt_pageid`, `cmt_protected`, `cmt_protected_var`, `cmt_protected_loginpage`, `cmt_link`, `cmt_link_target`) VALUES
(1, 'WEBSITE', 'root', 1, '1', '', 'folder', 'de', '1', '2009-04-06 12:00:00', '1', '1', 1, 0, '', 'root', '', ''),
(2, 'TESTAREA', 'root', 2, '1', '', 'folder', 'de', '0', '2009-04-06 12:00:00', '1', '1', 0, NULL, NULL, NULL, NULL, NULL),
(3, 'Testseite', '1', 1, '1', '', 'page', '', '0', '2009-04-06 20:08:38', '1', '1', 0, 0, 'cmt_visitorloggedin', 'root', '', '');
...
CREATE TABLE `cmt_sessions` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_sessionid` varchar(32) default NULL,
...
CREATE TABLE `cmt_sessions_raw` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_sessionid` varchar(32) NOT NULL default '',
  `cmt_time` int(11) default NULL,
  `cmt_page` varchar(128) default NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;
...
CREATE TABLE `cmt_session_details` (
  ...
  `cmt_loggedin` tinyint(1) default '0',
  `cmt_userid` int(11) default NULL,
  `cmt_useragent` varchar(128) default NULL,
  `cmt_referer` varchar(128) default NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;
...
CREATE TABLE `cmt_tables` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_tablename` varchar(255) default NULL,
  `cmt_showname` varchar(255) default NULL,
  `cmt_charset` varchar(255) NOT NULL default '',
  `cmt_collation` varchar(255) default NULL,
  `cmt_include` varchar(255) default NULL,
  `cmt_itempos` int(11) default NULL,
  `cmt_addvars` text,
  `cmt_showfields` text,
  `cmt_editstruct` text,
  `cmt_group` varchar(255) default NULL,
  `cmt_ownservice` varchar(255) default NULL,
  `cmt_type` varchar(255) default NULL,
  `cmt_templates` text,
...
(9, '', 'Layout', '', NULL, 'app_layout.php', 3, 'sort_fields = 2\nsort_directions = 2\nsearch_fields = 2\nshow_ipp = 1\nshow_iteminfos = 1\nadd_item = 1\nsort_aliases = 1\nshow_pageselect = 1\nsearch_aliases = 1\ntable_alias = \nshow_ippnumber = 10\nshow_query = 0\ncmt_ownservice = \ntable_icon = \n', '', '', '16', '', 'application', 'a:4:{s:18:"dont_use_templates";s:1:"1";s:14:"overview_frame";s:0:"";s:12:"overview_row";s:0:"";s:9:"editentry";s:0:"";}', 1, '_top', '', NULL, 'a:23:{s:12:"table_select";s:1:"1";s:11:"sort_fields";s:1:"2";s:8:"sort_dir";s:1:"2";s:14:"sort_direction";s:1:"2";s:13:"search_fields";s:1:"2";s:8:"show_ipp";s:1:"1";s:14:"show_iteminfos";s:1:"1";s:8:"add_item";s:1:"1";s:11:"enter_query";s:1:"0";s:15:"show_pageselect";s:1:"1";s:7:"uploads";s:1:"6";s:4:"root";s:0:"";s:19:"show_all_subfolders";s:0:"";s:12:"cmt_showname";s:12:"Code-Manager";s:16:"import_directory";s:14:"import_export/";s:15:"sort_directions";s:1:"2";s:12:"sort_aliases";s:1:"1";s:14:"search_aliases";s:1:"1";s:11:"table_alias";s:0:"";s:14:"show_ippnumber";s:2:"10";s:10:"show_query";s:1:"0";s:14:"cmt_ownservice";s:0:"";s:10:"table_icon";s:0:"";}'),
...
(16, 'cmt_content_languages', 'Sprachversionen', 'utf8', 'utf8_unicode_ci', '', 6, 'sort_fields = 2\r\nsort_directions = 2\r\nsearch_fields = 2\r\nshow_ipp = 1\r\nshow_iteminfos = 1\r\nadd_item = 1\r\nsort_aliases = 1\r\nshow_pageselect = 1\r\nsearch_aliases = 1\r\ntable_alias = \r\nshow_ippnumber = 10\r\nshow_query = 0\r\ncmt_ownservice = \r\ntable_icon =', '', '', '16', '', 'table', '', 0, '', '', 0, 'a:13:{s:10:"table_icon";s:7:"default";s:11:"sort_fields";s:1:"2";s:12:"sort_aliases";s:1:"1";s:15:"sort_directions";s:1:"2";s:13:"search_fields";s:1:"2";s:14:"search_aliases";s:1:"1";s:8:"show_ipp";s:1:"1";s:14:"show_ippnumber";s:2:"10";s:15:"show_pageselect";s:1:"1";s:14:"show_iteminfos";s:1:"1";s:14:"cmt_ownservice";s:0:"";s:8:"add_item";s:1:"1";s:10:"show_query";s:1:"1";}'),
...
(1, 'Administration', 2, 1, 0, 'a:2:{s:4:"icon";s:9:"otherIcon";s:8:"iconPath";s:24:"altimg/groups/1/icon.png";}'),
...
(16, 'Link (automatisch): zurück zur vorherigen Seite', '<div class=\\"link_back\\"><img src=\\"{CONSTANT:PATHTOWEBROOT}img/link_back.gif\\">\r\n{IF ({LAYOUTMODE})}zu verlinkender Text:<br><span>{HEAD:1}</span>\r\n{ELSE}<a href=\\"index.php?sid={SID}&pid={PAGEVAR:refering_page}&#9001;={PAGELANG}\\">{HEAD:1}</a>{ENDIF}</div>', 8),
...
--
-- Daten f�r Tabelle `cmt_templates_pages`
--
...
CREATE TABLE `cmt_users` (
  `id` int(11) NOT NULL auto_increment,
  `cmt_username` varchar(64) default NULL,
  `cmt_pass` varchar(64) default NULL,
  `cmt_exptime` int(11) default NULL,
  `cmt_uservars` text,
  `cmt_creationdate` datetime default NULL,
  `cmt_passchanged` datetime default NULL,
  `cmt_lastlogin` datetime default NULL,
  `cmt_usergroup` varchar(255) default NULL,
  `cmt_restrictions` text,
  `cmt_addvars` text,
  `cmt_showfields` text,
  `cmt_editstruct` text,
  `cmt_useralias` varchar(255) default NULL,
  `cmt_showitems` text,
  `cmt_usertype` varchar(255) default NULL,
  `cmt_userdirectory` varchar(255) default NULL,
  `cmt_startpage` varchar(255) default NULL,
  `cmt_startapp` varchar(255) default NULL,
  `cmt_cmtstyle` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM ;
...
(1, 'cmt', '2ec987485e4d734faeb439a7427f8633', 0, 'a:1:{s:12:"cmt_uservars";a:3:{i:18;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"sort_dir";a:2:{i:1;s:3:"asc";i:2;s:3:"asc";}}i:2;a:1:{s:6:"cmtIpp";s:2:"30";}i:11;a:3:{s:7:"cmt_ipp";s:2:"10";s:7:"sort_by";s:0:"";s:8:"sort_dir";s:0:"";}}}', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2009-04-06 20:06:44', '1', '', '', '', '', 'John Doe', '', 'admin', '', '', '17', 'default/');
...
CREATE TABLE `cmt_users_groups` (
  ...
  `cmt_showfields` text,
  `cmt_editstruct` text,
  `cmt_grouptype` varchar(255) default NULL,
  `cmt_startpage` varchar(255) default NULL,
  `cmt_startapp` varchar(255) default NULL,
  `cmt_groupdirectory` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM ;
