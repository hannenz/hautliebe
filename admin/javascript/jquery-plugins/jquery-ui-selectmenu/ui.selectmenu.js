...
$.widget("ui.selectmenu", {
	...
	_init: function() {
		...
		*/
		...
		//selectmenu style
		this.newelement.addClass(self.widgetFullName+"-dropdown");
		this.list.addClass(self.widgetFullName+"-menu-dropdown");	
...
//			}
	...
	_refreshValue: function() {
		...
		this.list
			...
			.removeClass(this.widgetFullName + "-item-selected")
			.find('a')
			.attr('aria-selected', 'false')
			.attr('id', '');
		//select new
		this._selectedOptionLi()
			.addClass(this.widgetFullName + "-item-selected")
			.find('a')
...
//		var menuTop = this.newelement.offset().top + this.newelement.height();
		...
		var selectPos = parseInt(jQuery(this.newelement).offset().top);
		var selectHeight = parseInt(jQuery(this.newelement).height());
		var documentHeight = parseInt(jQuery(document).height());
//		console.info(this.newelement);
...
//		console.info((selectPos + listHeight), viewportBottomPos)
		...
		if ((selectPos + listHeight) < viewportBottomPos) {
			...
			this.newelement.removeClass('ui-corner-all').removeClass('ui-corner-bottom').addClass('ui-corner-top');
			this.list.removeClass('ui-corner-all').removeClass('ui-corner-top').addClass('ui-corner-bottom');
//			console.info('bottom');
			...
			this.newelement.removeClass('ui-corner-all').removeClass('ui-corner-top').addClass('ui-corner-bottom');
